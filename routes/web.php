...
Route::post('/SubKriteria/edit/{sub_kriteria_id}', [SubKriteriaController::class, 'edit'])->name('subkriteria.edit');
Route::get('/SubKriteria/destroy/{sub_kriteria_id}', [SubKriteriaController::class, 'destroy'])->name('subkriteria.destroy');

/* Alternatif */
Route::get('/Alternatif', [AlternatifController::class, 'index'])->name('Alternatif');
Route::get('/Alternatif/tambah', [AlternatifController::class, 'tambah'])->name('alternatif.tambah');
Route::get('/Alternatif/edit/{alternatif_id}', [AlternatifController::class, 'edit'])->name('alternatif.edit');
Route::get('/Alternatif/destroy/{alternatif_id}', [AlternatifController::class, 'destroy'])->name('alternatif.destroy');
Route::post('/Alternatif/simpan', [AlternatifController::class, 'simpan']);
Route::post('/Alternatif/upload', [AlternatifController::class, 'upload']);
Route::post('/Alternatif/update/{alternatif_id}', [AlternatifController::class, 'update'])->name('alternatif.update');
...
Route::get('/Periode/edit/{periode_id}', [PeriodeController::class, 'edit'])->name('periode.edit');
Route::get('/Periode/destroy/{periode_id}', [PeriodeController::class, 'destroy'])->name('periode.destroy');
...
Route::post('/Profile/update/{user_id}', [ProfileController::class, 'update'])->name('profile.update');
