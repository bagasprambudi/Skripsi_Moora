...
<div class="mb-4">
    ...
    <div class="alert alert-success">
        ...
        Selamat Datang <span class="text-uppercase"><b>{{ session('log.nama') }}!</b></span> Anda Bisa Mengoperasikan Sistem Bantuan Sosial Desa Wonomerto.
    </div>
    <div class="row">
            ...
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><a href="{{ url('Periode') }}" class="text-secondary text-decoration-none">Data Periode</a></div>
                        </div>
                        <div class="col-auto">
		...
		<div class="col-xl-4 col-md-6 mb-4">
            <div class="card border-left-danger shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><a href="{{ url('Hasil') }}" class="text-secondary text-decoration-none">Data Hasil Perangkingan</a></div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-xl-4 col-md-6 mb-4">
            <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><a href="{{ url('Penerima') }}" class="text-secondary text-decoration-none">Data Penerima Bansos</a></div>
                        </div>
                        <div class="col-auto">
...
<div class="mb-4">
    ...
    <div class="alert alert-success">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
        Selamat Datang <span class="text-uppercase"><b>{{ session('log.nama') }}!</b></span> Anda Dapat Menggunakan Sistem Dengan Wewenang Tertentu Melalui Pilihan Menu Di Bawah.
    </div>
    <div class="row">
